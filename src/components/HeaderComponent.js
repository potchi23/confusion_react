...
class Header extends Component{
    ...
    handleLogin(event){
        this.toggleModal();
        alert("Username : " + this.username.value + " Password : " + this.username.value + " Remember : " + this.remember.checked)
                ...
                <ModalBody>
                    <Form onSubmit={this.handleLogin}>
                        ...
                        <FormGroup>
                            ...
                            <Input type="password" id="password" name="password" className="mb-4"
