...
import { Control, Error, actions, Errors } from 'react-redux-form';
...
class Contact extends Component {
    ...
    handleSubmit(values){
        ...
        this.props.postFeedback(1, values.firstname, values.lastname, values.telnum, values.email, values.agree, values.contactType, values.messages);
                        ...
                        <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                            ...
                            <Row classname="form-group" row>
                                ...
                                <Col md={{size:3, offset:2}}>
                                    <Control.select model=".contactType" name="contactType" className="select">
                                        <option>Tel.</option>
                                        <option>Email</option>
                                    </Control.select>
                                </Col>
